                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Add Video
                                    ...
                                    <div style="padding:20px;">
                                            <form action="<?php echo base_url('AddVideo_Act'); ?>" method="POST" enctype="multipart/form-data">
                                            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                                                <label for="title">Video</label>
                                                <input type="text"class="form-control" id="title" name="video" placeholder="Video Linki Daxil Edin">
                                                <br>
