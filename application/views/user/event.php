    ...
    <section class="ftco-section">
    	<div class="container">
        	...
        	<div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.html" class="block-20" style="background-image: url(<?php echo base_url('assets/user/'); ?>images/event-1.jpg);">
              </a>
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="blog-single.html" class="block-20 align-self-end" style="background-image: url(<?php echo base_url('assets/user/'); ?>images/event-2.jpg);">
              </a>
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                  <div><a href="#">Sep. 10, 2018</a></div>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry align-self-stretch">
              <a href="blog-single.html" class="block-20" style="background-image: url(<?php echo base_url('assets/user/'); ?>images/event-3.jpg);">
              </a>
              <div class="text p-4 d-block">
              	<div class="meta mb-3">
                  <div><a href="#">Sep. 10, 2018</a></div>
